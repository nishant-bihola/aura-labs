...
export default function AnalyticsPage() {
  ...
  const lineData = trendPeriods.map((p) => {
    ...
    return {
      ...
      ...(payAmount > 0 ? { Income: payAmount, Saved: parseFloat((payAmount - total).toFixed(2)) } : {}),
    };
  });
    ...
    <div className="space-y-5">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-0.5">Visual breakdown of your spending habits</p>
        </div>
        <select
      ...
      {transactions.length === 0 ? (
        <div className="card p-16 text-center text-slate-500">
          ...
          <p className="text-sm mt-1">Add transactions to see your analytics</p>
        </div>
      ) : (
        <>
            ...
            <div className="card p-5">
              ...
              <ResponsiveContainer width="100%" height={280}>
                <LineChart data={lineData} margin={{ top: 5, right: 20, left: -15, bottom: 0 }}>
                  ...
                  <Line type="monotone" dataKey="Spent" stroke="#818cf8" strokeWidth={2.5} dot={{ fill: '#818cf8', r: 4, strokeWidth: 0 }} activeDot={{ r: 6 }} />
                  {payAmount > 0 && (
                    ...
                    <div key={cat}>
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <div className="text-sm text-right">
                          <span className="font-bold text-white tabular-nums">${allTimeSpend.toFixed(2)}</span>
